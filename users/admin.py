...
class CustomUserAdmin(UserAdmin):
	...
	list_filter = ()
	fieldsets = (
        (('User'), {'fields': ('email','nombre','apellido_uno','apellido_dos','cedula','fecha_nacimiento','genero','fecha_ingreso','numero_empleado','cargo','jefe','zona', 'municipio','departamento','ventas','imagen','celular',)}),
